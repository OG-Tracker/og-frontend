  ...
  return (
    <div className={className}>
      {items.map((item, index) => (
        ...
        >
          <div
            className={`flex justify-between cursor-pointer transition duration-150 font-medium w-full text-start text-base text-kog-white dark:text-slate-300 px-8 py-4 ${
              activeIndex === index
                ? "bg-slate-50 dark:bg-slate-700 dark:bg-opacity-60 rounded-t-md "
                : "bg-kog-999 dark:bg-slate-700  rounded-md"
            }`}
            ...
            <div
              className={`${
                index === activeIndex
                  ...
                  : "l"
              } text-sm text-kog-white font-normal bg-kog-999 dark:bg-slate-900 dark:text-slate-300 rounded-b-md`}
            >
              <div
                className="px-8 py-4"
