...
const Modal = ({
  ...
  centered,
  scrollContent,
  themeClass = "bg-slate-900 dark:bg-kog-50 dark:border-b dark:border-slate-700",
  title = "Basic Modal",
  uncontrol,
  label = "Basic Modal",
  labelClass,
            ...
            >
              ...
              <div className="fixed inset-0 overflow-y-auto">
                ...
                >
                 ...
                 bg-kog-999 dark:bg-kog-50 text-left align-middle shadow-xl transition-alll ${className}`}
                    >
                      <div
