...
const ProductList = ({ item }) => {
  ...
  return (
    <Card bodyClass=" rounded-md" className="group  border-kog-700 border-2 hover:bg-kog-100 hover:bg-opacity-70  duration-150 ease-out hover:ease-in">
      ...
      <div className="shadow-[inset_0px_0px_10px_7px_rgba(0,0,0,0.4)] hover:shadow-[0px_0px_7px_7px_rgba(166,0,157,0.3)] pt-3  p-4">
        {/* <p className="text-xs	  text-slate-300 font-normal uppercase pb-2">
          {category}
        </p>
        <h6 className="  text-slate-300 text-lg	font-medium	pb-2 w-full truncate">
        ...
        /* {rating && (
          <span className="flex items-center   text-slate-300  font-normal text-xs space-x-[4px] rtl:space-x-reverse pb-3">
        ...
        <div className="space-x-4 rtl:space-x-reverse grid md:grid-cols-5">
          ...
          <div className={`truncate ${isSpecialPath ? 'col-span-6' : 'col-span-4'}`}>

            <Link to={item.id}>
              <div className="flex justify-between items-center border-b border-kog-300 pb-1">
                <p className="font-extrabold text-lg 	  text-slate-300 uppercase ">
                  #{refNum}
                </p>
                ...
                <p className="text-sm	  text-slate-300 uppercase font-normal grid grid-cols-3 gap-x-1 justify-items-end">
            ...
            <div className="flex justify-between items-center mb-3 " >
              <h6 className="  text-slate-300 text-base	font-medium	mt-2 truncate	">
          ...
          {!isSpecialPath && (
            <>
              ...
              <div className=" justify-center center m-auto hidden md:flex">
