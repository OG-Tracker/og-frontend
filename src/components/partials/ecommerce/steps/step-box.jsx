...
const StepBox = ({ item, index, stepNumber }) => {
  ...
  return (
    <li
      className={clsx(
        "relative flex  bg-kog-999 dark:bg-slate-700  items-center justify-center text-center  lg:border border-slate-300 dark:border-slate-700 rounded-t xl:px-10 xl:py-7 lg:px-3 lg:py-6  transition-all duration-150 after:absolute  after:bottom-[-8px] after:rounded-b after:w-full lg:after:h-2",
        {
