...
const ProductBox = ({ item, wish }) => {
  ...
  // };
  // TODO edit proposal grid
  return (
    // animate-border inline-block rounded-md bg-white bg-gradient-to-r from-red-500 via-purple-500 to-blue-500 bg-[length:400%_400%]
    <Card bodyClass=" rounded-md" className="group  border-kog-700 border-2 hover:bg-kog-100 hover:bg-opacity-70  duration-150 ease-out hover:ease-in">
      {/* <Link to={item.id}>
        <div className="rounded relative h-[1px] flex flex-col justify-center items-center mb-3 rounded-md ">
          ...
          <div className="hover-box flex flex-col invisible absolute ltr:right-2 rtl:left-2 top-2 opacity-0 group-hover:visible group-hover:opacity-100 transition-all duration-300 ">
            {wish ? (
              <button className="bg-kog-999 p-2.5  mb-1.5 rounded-full hover:bg-danger-600  hover:bg-danger-600 hover:text-white hover:text-white text-kog-400">
      ...
      {/* <button className="bg-kog-999 p-2.5  mb-1.5 rounded-full">
                    <Icon
                      icon="ph:heart-fill"
                      className="text-kog-400 text-kog-400 hover:text-danger-600 hover:text-danger-600"
                    />
                  </button> */}
      {/* <button className="p-2.5 mb-1.5 rounded-full border-solid border-2 border-[#890F83] ">
                  <Icon
                    icon="ph:eye"
                    className="text-kog-400 text-kog-400 hover:text-danger-600  hover:text-[#890F83]"
                  />
                </button> */}
      {/* <button className="bg-kog-999 p-2.5 mb-1.5 rounded-full ">
                    <Icon
      ...
      <div className="shadow-[inset_0px_0px_10px_7px_rgba(0,0,0,0.4)] hover:shadow-[0px_0px_7px_7px_rgba(166,0,157,0.3)]  p-4">
        <Link to={item.id}>
          <div className="flex justify-between items-center border-b border-kog-300 pb-3 ">
            ...
            <span className="text-2xl	border-kog-300 text-kog-white px-2 py-2 rounded-full mx-1 p-1 shadow-[0px_0px_10px_5px_rgba(0,0,0,0.4)] bg-gradient-to-t from-kog-300 to-kog-800   ml-3">
              {status === 'Delivered' ? <VerifiedIcon /> : status === 'In progress' ? <Icon icon="eos-icons:hourglass" className="text-white" /> : status === 'Flagged' ? <MyIcon/> : null}
              
            </span>
            <p className="text-lg	text-white  uppercase font-normal grid grid-cols-3 gap-x-1 justify-items-end">
              <div className="font-extrabold text-xl col-span-2 align-top">{item.reqDot}</div> 
              <div className="bg-polkalogo w-5 h-5 bg-no-repeat mt-1 animate-spin-slow mix-blend-plus-lighter opacity-60 "></div>
              
            </p>
            {/* {rating && (
            <span className="flex items-center text-kog-900   font-normal text-xs space-x-1  rtl:space-x-reverse ">
        ...
        <div className="flex justify-between items-center " >
          <h6 className="text-kog-900  text-base	font-medium	mt-2 truncate	">
          ...
          <p className="border-kog-300 text-kog-white px-3 py-1 rounded-3xl mx-1 p-2 shadow-[0px_0px_10px_2px_rgba(0,0,0,0.2)] transition-all duration-200 ease-in-out bg-gradient-to-t from-kog-100 to-kog-300  ">{category}</p>

        </div>
        <br />
        <div className="grid grid-cols-12 shadow-[inset_0px_0px_35px_rgba(0,0,0)] justify-center items-center divide-x divide-kog-900 border rounded-full border-kog-500 divide-x-5 py-1 bg-transparent" >
          ...
          <Link className="   border-solid col-span-3  border-[#890F83] px-2 py-1 " to={subLink} target="_blank" >
          <div class="rounded-full p-2 shadow-[0px_0px_10px_5px_rgba(0,0,0,0.4)] transition-all duration-200 ease-in-out bg-gradient-to-t text-white from-kog-300 to-kog-500 hover:bg-gradient-to-l focus:ring-4 focus:outline-none focus:ring-purple-200 dark:focus:ring-purple-800 text-center  hover:bg-kog-500 m-auto max-w-[45px] min-h-[45px] hover:max-w-full hover:shadow-[0px_0px_10px_5px_rgba(0,0,0,0.4)] 		">
          ...
          <Link className="border-solid  col-span-3  border-[#890F83]  px-2 py-1   z-50 " to={scanLink} target="_blank">
          <div class="rounded-full p-2 shadow-[0px_0px_10px_5px_rgba(0,0,0,0.4)] transition-all duration-200 ease-in-out bg-gradient-to-t text-white from-kog-300 to-kog-500 hover:bg-gradient-to-l focus:ring-4 focus:outline-none focus:ring-purple-200 dark:focus:ring-purple-800 text-center  hover:bg-kog-500 m-auto max-w-[45px] min-h-[45px] hover:max-w-full hover:shadow-[0px_0px_10px_5px_rgba(0,0,0,0.4)] 		">
          ...
          <Link className="border-solid  col-span-3   border-[#890F83]  px-2 py-1  text-2xl text-[#fff] z-50" to={propLink} target="_blank">
          <div class="rounded-full p-2 shadow-[0px_0px_10px_5px_rgba(0,0,0,0.4)] transition-all duration-200 ease-in-out bg-gradient-to-t text-white from-kog-300 to-kog-500 hover:bg-gradient-to-l focus:ring-4 focus:outline-none focus:ring-purple-200 dark:focus:ring-purple-800 text-center  hover:bg-kog-500 m-auto max-w-[45px] min-h-[45px] hover:max-w-full hover:shadow-[0px_0px_10px_5px_rgba(0,0,0,0.4)] 		">
        ...
        <div className="flex justify-between items-center max-w-6 text-sm text-kog-500 my-1">
          <p className="text-kog-900">{fdate}</p>
          
          <p className="text-white text-base"><Timer  startDate={fdate} endDate={ldate} />  </p>
          <p className="text-kog-900">{ldate}</p>
        </div>
        <ProgressBarTimer  startDate={fdate} endDate={ldate} theHeight={26} />
        {/* <ProgressBar startDate={fdate} endDate={ldate} /> */}
        {/* <Timer endDate={ldate} /> */}
        ...
        {/* {cartItems.some((cartItem) => cartItem.id === id) ? (
          ...
          <Button
            ...
            className="btn-outline-dark w-full btn-sm  font-medium hover:bg-slate-900 hover:text-white hover:text-white  hover:bg-slate-700 "
