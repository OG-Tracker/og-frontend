    ...
    <div className="grid md:grid-cols-3 grid-cols-1 gap-5">
      {products.map((item, i) => (
        ...
        >
          ...
          <span className="text-kog-white dark:text-slate-300 text-sm mb-4 block">
            {item.title}
          </span>
          <a
            href="#"
            className="btn btn-secondary dark:bg-kog-50 dark:hover:bg-slate-600 block w-full text-center btn-sm"
          >
            View More
          </a>
        </div>
