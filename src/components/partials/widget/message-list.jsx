      ...
      <ul className="divide-y divide-slate-100 dark:divide-slate-700 -mx-6 -mb-6">
        {newMessage?.map((item, i) => (
          <li key={i}>
            <Link
              to="chat"
              className="hover:bg-slate-100 dark:hover:bg-slate-600 dark:hover:bg-opacity-70 hover:text-slate-800 text-kog-white dark:text-slate-300 block w-full px-4 py-3 text-sm mb-2 last:mb-0 cursor-pointer"
            >
              <div className="flex ltr:text-left rtl:text-right">
                <div className="flex-none ltr:mr-3 rtl:ml-3">
                  <div className="h-8 w-8 bg-kog-999 dark:bg-slate-700 rounded-full relative">
                    <span
                      className={`${
                ...
                <div className="flex-1">
                  ...
                  <div className="text-xs hover:text-[#68768A] font-normal text-kog-white dark:text-slate-300">
                    {item.desc}
                  </div>
