...
const MobileFooter = () => {
  return (
    <div className="bg-kog-999 bg-no-repeat custom-dropshadow footer-bg dark:bg-slate-700 flex justify-around items-center backdrop-filter backdrop-blur-[40px] fixed left-0 w-full z-[9999] bottom-0 py-[12px] px-4">
      <NavLink to="chat">
        {({ isActive }) => (
          <div>
            <span
         ...
         ${isActive ? "text-primary-500" : "dark:text-white text-slate-900"}
          ...
          ${
            isActive ? "text-primary-500" : "text-kog-white dark:text-slate-300"
          }
          `}
            >
              Messages
      ...
      <NavLink
        to="profile"
        className="relative bg-kog-999 bg-no-repeat backdrop-filter backdrop-blur-[40px] rounded-full footer-bg dark:bg-slate-700 h-[65px] w-[65px] z-[-1] -mt-[40px] flex justify-center items-center"
      >
        {({ isActive }) => (
