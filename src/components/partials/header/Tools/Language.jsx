      ...
      <Listbox value={selected} onChange={setSelected}>
        <div className="relative z-[22]">
          <Listbox.Button className="relative w-full flex items-center cursor-pointer space-x-[6px] rtl:space-x-reverse">
            ...
            <span className="text-sm md:block hidden font-medium text-kog-white dark:text-slate-300">
              {selected.name}
            </span>
          </Listbox.Button>
          <Transition
            ...
            leaveTo="opacity-0"
          >
            <Listbox.Options className="absolute min-w-[100px] ltr:right-0 rtl:left-0 md:top-[50px] top-[38px] w-auto max-h-60 overflow-auto border border-slate-200 dark:border-slate-700 rounded bg-kog-999 dark:bg-kog-50 mt-1 ">
              {months.map((item, i) => (
