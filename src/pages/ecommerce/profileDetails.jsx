...
export const ProfileDetails = () => {
  ...
  let { proposer } = useParams();
  const {
    data: getProduct,
    isLoading,
    isError,
    error,
  } = useGetProductQuery(proposer);
  ...
  //   );
  // };
  const isValidID = product && product.proposer === proposer;
            ...
            <Tab.Panels>
              ...
              <Tab.Panel>
                <div className="text-kog-white text-sm lg:text-base font-normal grid grid-cols-1 md:grid-cols-2 pb-10">
                  <div className=" border-r-2 border-kog-200 px-5 min-h-[65vh]">
                    <div className="flex justify-between items-center">
                      <div>
                        <p className="align-middle">
                          <span className="align-middle text-slate-300 text-2xl	font-medium	mt-2 ">#{product?.refNum}</span>
                          <span className="align-middle text-kog-400"> ⦿ </span>
                          <span className="align-middle text-slate-300 text-xl	font-medium	mt-2  mx-1">{product?.fdate}</span>
                          <span className="align-middle text-kog-400 "> ⦿ </span>
                      ...
                      <p className="text-2xl	border-kog-300 text-kog-white px-2 py-2 rounded-full mx-1 p-1 shadow-[0px_0px_10px_5px_rgba(0,0,0,0.4)] bg-gradient-to-t from-kog-300 to-kog-800 ml-3">
                        {/* {product?.status} */}
                    ...
                    <p className=" text-slate-300 text-3xl	font-medium	mt-5 ">
                      {product?.ptitle}
                    </p>
                    ...
                    {/* <div className="mt-8 grid grid-cols-4 lg:grid-cols-8 w-full shadow-[inset_0px_0px_25px_rgba(0,0,0)] justify-center items-center divide-x divide-kog-400 border rounded-full border-kog-500 py-2  bg-transparent">
                      <Link target="_blank" to={product?.twitter} className="flex justify-center items-center text-2xl px-2" >
                      ...
                      <Link target="_blank" to={product?.website} className="flex justify-center items-center text-2xl px-2">
                        <div class="rounded-full p-2 shadow-[0px_0px_10px_5px_rgba(0,0,0,0.4)] transition-all duration-200 ease-in-out bg-gradient-to-t hover:bg-gradient-to-l from-kog-300 to-kog-500 hover:bg-kog-500 flex justify-center items-center m-auto min-w-[45px] min-h-[45px] hover:min-w-full hover:shadow-[0px_0px_10px_5px_rgba(0,0,0,0.4)]">
                          <Icon className={'m-auto text-white'} icon="streamline:web" />
                        </div>
                      </Link>

                      <Link target="_blank" to={product?.github} className="flex justify-center items-center text-2xl px-2">
                        <div class="rounded-full p-2 shadow-[0px_0px_10px_5px_rgba(0,0,0,0.4)] transition-all duration-200 ease-in-out bg-gradient-to-t hover:bg-gradient-to-l from-kog-300 to-kog-500 hover:bg-kog-500 flex justify-center items-center m-auto min-w-[45px] min-h-[45px] hover:min-w-full hover:shadow-[0px_0px_10px_5px_rgba(0,0,0,0.4)]">
                          <Icon className={'m-auto text-white'} icon="mdi:github" />
                        </div>
                      </Link>

                      <Link target="_blank" to={product?.youtube} className="flex justify-center items-center text-2xl px-2" >
                        <div class="rounded-full p-2 shadow-[0px_0px_10px_5px_rgba(0,0,0,0.4)] transition-all duration-200 ease-in-out bg-gradient-to-t hover:bg-gradient-to-l from-kog-300 to-kog-500 hover:bg-kog-500 flex justify-center items-center m-auto min-w-[45px] min-h-[45px] hover:min-w-full hover:shadow-[0px_0px_10px_5px_rgba(0,0,0,0.4)]">
                          <Icon className={'m-auto text-white'} icon="mdi:youtube" />
                        </div>
                      </Link>

                      <Link target="_blank" to={product?.articles} className="flex justify-center items-center text-2xl px-2">
                        <div class="rounded-full p-2 shadow-[0px_0px_10px_5px_rgba(0,0,0,0.4)] transition-all duration-200 ease-in-out bg-gradient-to-t hover:bg-gradient-to-l from-kog-300 to-kog-500 hover:bg-kog-500 flex justify-center items-center m-auto min-w-[45px] min-h-[45px] hover:min-w-full hover:shadow-[0px_0px_10px_5px_rgba(0,0,0,0.4)]">
                    ...
                    <div className="mt-8 grid grid-cols-4 lg:grid-cols-8 w-full shadow-[inset_0px_0px_25px_rgba(0,0,0)] justify-center items-center divide-x divide-kog-400 border rounded-full border-kog-500 py-2  bg-transparent">
                      {product?.twitter && !product.twitter.includes('-') ? (
                        <a href={product.twitter} target="_blank" className="flex justify-center items-center text-2xl px-2">
                        ...
                        <Tooltip title="d" placement="bottom" className="btn btn-outline-kog-900 bg-kog-100 dark:text-kog-900 dark:hover:bg-kog-900 dark:hover:text-white rounded-full px-4 py-1 shadow-[0px_0px_10px_5px_rgba(0,0,0,0.3)]" arrow allowHTML interactive theme="custom-light" maxWidth="220px" content={<div className="dark:text-slate-300 text-kog-white text-sm">N/A</div>}>
                          <div className="flex justify-center items-center text-2xl px-2 cursor-not-allowed">
                      ...
                      {product?.website && !product.website.includes('-') ? (
                        <a href={product.website} target="_blank" className="flex justify-center items-center text-2xl px-2">
                          <div className="rounded-full p-2 shadow-[0px_0px_10px_5px_rgba(0,0,0,0.4)] transition-all duration-200 ease-in-out bg-gradient-to-t hover:bg-gradient-to-l from-kog-300 to-kog-500 hover:bg-kog-500 flex justify-center items-center m-auto min-w-[45px] min-h-[45px] hover:min-w-full hover:shadow-[0px_0px_10px_5px_rgba(0,0,0,0.4)]">
                            <Icon className={'m-auto text-white'} icon="streamline:web" />
                          </div>
                        </a>
                      ...
                      {product?.github && !product.github.includes('-') ? (
                        <a href={product.github} target="_blank" className="flex justify-center items-center text-2xl px-2">
                          <div className="rounded-full p-2 shadow-[0px_0px_10px_5px_rgba(0,0,0,0.4)] transition-all duration-200 ease-in-out bg-gradient-to-t hover:bg-gradient-to-l from-kog-300 to-kog-500 hover:bg-kog-500 flex justify-center items-center m-auto min-w-[45px] min-h-[45px] hover:min-w-full hover:shadow-[0px_0px_10px_5px_rgba(0,0,0,0.4)]">
                            <Icon className={'m-auto text-white'} icon="mdi:github" />
                          </div>
                        </a>
                      ...
                      {product?.youtube && !product.youtube.includes('-') ? (
                        <a href={product.youtube} target="_blank" className="flex justify-center items-center text-2xl px-2">
                          <div className="rounded-full p-2 shadow-[0px_0px_10px_5px_rgba(0,0,0,0.4)] transition-all duration-200 ease-in-out bg-gradient-to-t hover:bg-gradient-to-l from-kog-300 to-kog-500 hover:bg-kog-500 flex justify-center items-center m-auto min-w-[45px] min-h-[45px] hover:min-w-full hover:shadow-[0px_0px_10px_5px_rgba(0,0,0,0.4)]">
                            <Icon className={'m-auto text-white'} icon="mdi:youtube" />
                          </div>
                        </a>
                      ...
                      {product?.articles && !product.articles.includes('-') ? (
                        <a href={product.articles} target="_blank" className="flex justify-center items-center text-2xl px-2">
                          <div className="rounded-full p-2 shadow-[0px_0px_10px_5px_rgba(0,0,0,0.4)] transition-all duration-200 ease-in-out bg-gradient-to-t hover:bg-gradient-to-l from-kog-300 to-kog-500 hover:bg-kog-500 flex justify-center items-center m-auto min-w-[45px] min-h-[45px] hover:min-w-full hover:shadow-[0px_0px_10px_5px_rgba(0,0,0,0.4)]">
                            <Icon className={'m-auto text-white'} icon="akar-icons:medium-fill" />
                          </div>
                        </a>
                      ...
                      {product?.subLink && !product.subLink.includes('-') ? (
                      ...
                      {product?.paLink && !product.paLink.includes('-') ? (
                      ...
                      {product?.scanLink && !product.scanLink.includes('-') ? (
                    ...
                    <div class="divide-y divide-solid divide-kog-300 text-lg">
                      ...
                      <div class="py-4 text-white font-semibold"><span className="text-kog-900">BENEFICIARY:</span>
                  ...
                  <div className="px-4 flex flex-col justify-between h-full">
                    ...
                    <p className="text-lg text-white px-8 py-4 rounded-lg shadow-[0px_0px_10px_3px_rgba(0,0,0,0.3)]">
                      {product?.summary}
                    </p>

                    {/* Adjustments start here: Place the tooltip trigger (button) at the bottom-right */}
                    {product?.track != "smallTipper" || product?.track != "bigTipper" || product?.track != "root" || product?.track != "refCanceller" || product?.track != "auctionAdmin" || product?.track != "generalAdmin" || product?.track != "fellowshipAdmin" || product?.track != "leaseAdmin" || product?.track != "stakingAdmin" || product?.track != "whitelistedCaller" ? (

                      <div className="mt-auto self-end mr-3 mb-[-5px]"> {/* This div ensures the button is pushed to the bottom-right */}
                        <Tooltip
                          ...
                          content={
                            <div className=" text-kog-white text-sm bg-kog-500">
                              Rank based on DOT requested by track.
                            </div>
                          }
                        />
                      </div>
              ...
              <Tab.Panel>
                ...
                <div>
                  ...
                  {product?.track === "smallTipper" || product?.track === "bigTipper" || product?.track === "root" || product?.track === "referendumCanceller" || product?.track === "auctionAdmin" || product?.track === "generalAdmin" || product?.track === "fellowshipAdmin" || product?.track === "leaseAdmin" || product?.track === "stakingAdmin" || product?.track === "treasurer" || product?.category === "Bounty" || product?.track === "whitelistedCaller" ? (
                    ...
                    <div className="text-slate-100 dark:text-slate-100 text-sm lg:text-base font-normal px-5 pb-10 grid grid-cols-1 md:grid-cols-3 ">
                      <div className="col-span-2">
                        <div className="p-10 min-h-[65vh] pt-1 ">
                          <h2 className=" text-kog-900 dark:text-kog-900 text-2xl	font-semibold	mt-2 font- ">
                            TASKS
                                  ...
                                  return (
                                    <li key={index} className="my-3 mx-5 rounded-md shadow-[0px_0px_5px_5px_rgba(0,0,0,0.3)] bg-kog-200 bg-opacity-40 hover:shadow-[0px_0px_3px_3px_rgba(137,15,131,0.5)] p-3 text-xl  duration-200">
                                      <div className="flex justify-between items-center w-full">
                                        <p className="text-xl flex col-span-11">{product[key]}</p>
                      ...
                      <div className="flex flex-col justify-between h-full border-l-2 border-kog-200 px-5">
                        <div >
                          ...
                          <div className="flex flex-col justify-center items-center min-h-[60vh]"> {/* Adjusted for vertical flex column */}
                            <div className="text-center mb-8"> {/* Added margin-bottom for spacing */}
                              ...
                              <CircularProgressBar startDate={product?.fdate} endDate={product?.ldate} size={300} strokeWidth={20} baseColor="#321a48" progressColor="#da18d0" textColor="#ff69b4" shadowColor="rgba(255, 105, 180, 0.2)" />
                            </div>
