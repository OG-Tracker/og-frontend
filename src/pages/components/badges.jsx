    ...
    <div className="grid xl:grid-cols-2 grid-cols-1 gap-5">
      <Card title="Basic Badges">
        <div className="space-xy-5">
          ...
          <Badge
            label="Dark"
            className="bg-kog-50 dark:bg-slate-900  text-white"
          />
        </div>
      </Card>
      <Card title="Pill Badges">
        <div className="space-xy-5">
          ...
          <Badge
            label="Dark"
            className="bg-kog-50 dark:bg-slate-900 text-white pill"
          />
        </div>
      </Card>
      <Card title="Soft Badges">
        <div className="space-xy-5">
          ...
          <Badge
            label="Dark"
            className="bg-kog-50 dark:bg-slate-900 text-slate-800 dark:text-slate-400 bg-opacity-[0.12]"
          />
        </div>
      </Card>
      <Card title="Soft Pill Badges">
        <div className="space-xy-5">
          ...
          <Badge
            label="Dark"
            className="bg-kog-50 dark:bg-slate-900 text-slate-800 dark:text-slate-400 bg-opacity-[0.12] pill"
          />
        </div>
      </Card>
        ...
        <div className="space-xy-5">
          <Button className="btn-dark">
            <div className="space-x-1 rtl:space-x-reverse">
              ...
              <Badge label="2" className="bg-kog-999 text-slate-900 " />
            </div>
          </Button>
          <Button className="btn-success">
            <div className="space-x-1 rtl:space-x-reverse">
              <span>Messages</span>
              <Badge label="4" className="bg-kog-999 text-slate-900 " />
            </div>
          </Button>
          <Button className="btn-info">
            <div className="space-x-1 rtl:space-x-reverse">
              <span>Draft</span>
              <Badge label="3" className="bg-kog-999 text-slate-900" />
            </div>
          </Button>
        </div>
      </Card>
