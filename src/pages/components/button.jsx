    ...
    <div className="grid xl:grid-cols-2 grid-cols-1 gap-5">
      <Card title="Basic">
        <div className="space-xy-5">
          ...
          <Button text="White" className="bg-kog-999 text-slate-900" />
        </div>
      </Card>
      <Card title="Outline">
        <div className="space-xy-5">
      ...
      <Card title="Raised">
        <div className="space-xy-5">
          ...
          <Button
            text="White"
            className=" bg-kog-999 text-slate-900 shadow-base2"
          />
        </div>
      </Card>
      <Card title="Rounded">
        <div className="space-xy-5">
          ...
          <Button
            text="White"
            className=" bg-kog-999 text-slate-900 rounded-[999px]"
          />
        </div>
      </Card>
      ...
      <Card title="Disabled">
        <div className="space-xy-5">
          ...
          <Button text="White" className=" bg-kog-999 text-slate-900" disabled />
        </div>
      </Card>
      <Card title="Loading">
        <div className="space-xy-5">
          ...
          <Button text="White" className=" bg-kog-999 text-slate-900" isLoading />
        </div>
      </Card>
      ...
      <Card title="Router Link">
        <div className="space-xy-5">
          ...
          <Button
            text="White"
            className=" bg-kog-999 text-slate-900"
            link="/dashboard"
          />
        </div>
      </Card>
