        ...
        <div className="space-y-5">
          <div>
            ...
            <div className="flex flex-wrap space-xy-5">
              ...
              <div>
                <div className="color-box h-[96px] 2xl:w-[107px] w-[96px] bg-kog-999 border-gray-500 border rounded-md flex flex-col text-slate-900 p-4 transition-all duration-200 hover:shadow-sm hover:-translate-y-1"></div>
                <div className="flex-1 text-sm my-1 pt-1 dark:text-slate-300">
                  White
                </div>
                <div className="flex-0 text-sm dark:text-slate-300">
