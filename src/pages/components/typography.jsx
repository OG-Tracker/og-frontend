    ...
    <div>
      <div className="grid lg:grid-cols-2 grid-cols-1 gap-5">
        <Card title="HTML headings Default">
          <div className="text-sm text-kog-white dark:text-slate-300">
          ...
          <div className="bg-slate-100 dark:bg-slate-700 text-xs text-kog-white dark:text-slate-300 flex justify-between py-3 px-6 items-center -mx-6 mt-6 mb-6 font-semibold">
            <span>PREVIEW</span>
            <span>FONT SIZE</span>
          </div>
          ...
          <div className="md:flex justify-between items-center mb-6">
            <h1>Heading 1</h1>
            <span className="text-sm text-kog-white dark:text-slate-300">
              60px
            </span>
          </div>
            ...
            <div className="-mx-6">
              <table className="w-full border-collapse border-none text-left">
                <thead>
                  <tr>
                    <th className="text-xs font-semibold bg-slate-100 dark:bg-slate-700">
                      <span className="px-6 py-5 block text-kog-white dark:text-slate-300">
                        Type
                      </span>
                    </th>
                    <th className="text-xs font-semibold bg-slate-100 dark:bg-slate-700">
                ...
                <tbody>
                  ...
                  <tr className="border-b border-slate-100 dark:border-slate-700">
                    <td className="text-kog-white dark:text-slate-300 text-left px-6 py-4 text-sm font-normal">
                      Body Text
                    </td>
                    <td className="text-kog-white dark:text-slate-300 text-base font-sm font-normal text-left t px-6 py-4">
                      text-sm
                    </td>
                    <td className="text-kog-white dark:text-slate-300 text-sm font-normal text-left px-6 py-4">
                      <div>
                        Cupcake ipsum dolor sit amet fruitcake donut chocolate.
                      </div>
                      <div className="text-xs text-slate-500 dark:text-slate-400 mt-1">
                  ...
                  <tr>
                    <td className="text-kog-white dark:text-slate-300 text-left px-6 py-4 text-xs font-normal">
                      Small Text
                    </td>
                    <td className="text-kog-white dark:text-slate-300 text-base font-xs font-normal text-left t px-6 py-4">
                      text-xs
                    </td>
                    <td className="text-kog-white dark:text-slate-300 text-xs font-normal text-left px-6 py-4">
                      <div>
                        Cupcake ipsum dolor sit amet fruitcake donut chocolate.
                      </div>
                      <div className="text-xs text-slate-500 dark:text-slate-400 mt-1">
        ...
        <Card title="Customizing headings  Default">
          <div className="text-sm text-kog-white dark:text-slate-300 mb-6">
        ...
        <div className="space-y-5">
          <Card title="Inline Text Elements">
            <div className="space-y-4">
              <p className="text-sm font-light text-kog-white dark:text-slate-300">
