      ...
      <div className="xl:col-span-2 col-span-1">
        <Card title="Link Colors">
          <div className="space-y-5">
            <Alert className="bg-kog-50 bg-opacity-[14%] text-slate-800 dark:bg-slate-500 dark:bg-opacity-[14%]  dark:text-slate-300">
            ...
            <Alert className="bg-secondary-500 bg-opacity-[14%] text-kog-white dark:bg-secondary-500 dark:bg-opacity-[14%]">
              This is an alert with
              <Link
                to="#"
                className="underline text-kog-white text-sm font-medium"
              >
                an example link
              </Link>
              .Click It out!
