  ...
  return (
    <div className=" space-y-5">
          ...
          <div className="p-6">
            ...
            <div className="mt-[71px]">
              <Button
                text="Learn more"
                link="#"
                className="btn bg-kog-999 text-slate-800"
              />
            </div>
          </div>
        </Card>
      ...
      <div className="grid xl:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-4 card-height-auto">
        ...
        <Card
          title="Sales Automation"
          className="bg-[#EDFFE5] dark:bg-kog-50"
          noborder
        >
          <div className="text-sm">
            Lorem ipsum dolor sit amet, consec tetur adipiscing elit, sed do
        ...
        <Card
          title="Sales Automation"
          className="bg-[#E5F9FF] dark:bg-kog-50	"
          noborder
        >
          <div className="text-sm">
            Lorem ipsum dolor sit amet, consec tetur adipiscing elit, sed do
      ...
      <div className="grid lg:grid-cols-2 grid-cols-1 gap-4 mt-5">
        ...
        <Card className="text-center ha-auto">
          <div className="text-2xl text-kog-white dark:text-slate-300">
