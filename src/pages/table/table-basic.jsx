          ...
          <div className="inline-block min-w-full align-middle">
            <div className="overflow-hidden ">
              <table className="min-w-full divide-y divide-slate-100 table-fixed dark:divide-slate-700">
                ...
                <tbody className="bg-kog-999 divide-y divide-slate-100 dark:bg-kog-50 dark:divide-slate-700">
                  {rows.map((row, i) => (
                    <tr key={i}>
          ...
          <div className="inline-block min-w-full align-middle">
            <div className="overflow-hidden ">
              <table className="min-w-full border border-slate-100 table-fixed dark:border-slate-700 border-collapse">
                  ...
                  <tr>
                    {columns.map((column, i) => (
                      <th
                        key={i}
                        scope="col"
                        className=" table-th border border-slate-100 dark:bg-kog-50 dark:border-slate-700 "
                      >
                        {column.label}
                      </th>
                    ))}
                ...
                <tbody className="bg-kog-999 ">
                  {rows.map((row, i) => (
                    <tr key={i}>
                      <td className="table-td border border-slate-100 dark:bg-kog-50 dark:border-slate-700">
                        {row.age}
                      </td>
                      <td className="table-td border border-slate-100 dark:bg-kog-50 dark:border-slate-700">
                        {row.first_name}
