...
const rabitWidget = [
  {
    bg: "bg-slate-900 dark:bg-kog-50",
  },
  {
    bg: "bg-primary-500",
  },
    ...
    <div className="space-y-5">
      <div className="grid md:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-5">
        ...
        >
          ...
          <div className="absolute top-1/2 -translate-y-1/2 ltr:right-6 rtl:left-6 mt-2 h-12 w-12 bg-kog-999 rounded-full text-xs font-medium flex flex-col items-center justify-center">
            Now
          </div>
        </div>
        {/* ?? end Single ?? */}
        ...
        >
          ...
          <div className="flex-none">
            <Button
              ...
              text="View details"
              btnclassName="btn-light bg-kog-999 btn-sm "
            />
          </div>
        </div>
        {/* ?? end Single ?? */}
        ...
        {rabitWidget.map((item, i) => (
          ...
          >
            ...
            <div className="mt-6 mb-14">
              <button className="btn bg-kog-999 hover:bg-opacity-80 text-slate-900 btn-sm">
                Upgrade
              </button>
            </div>
            <img
