  ...
  return (
    <div className=" space-y-5">
        ...
        <div className="grid xl:grid-cols-4 lg:grid-cols-2 md:grid-cols-2 grid-cols-1 gap-5 place-content-center">
          <div className="flex space-x-4 h-full items-center rtl:space-x-reverse">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm dark:text-slate-300">Welcome to ogtkog</p>
            </div>
          </div>
          <GroupChart5 />
        </div>
      ...
      <div className="grid xl:grid-cols-6 lg:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-4">
        <OrderChart className="bg-kog-999 dark:bg-kog-50 rounded p-4" />
        <OrderChart
          className="bg-kog-999 dark:bg-kog-50 rounded p-4"
          barColor={"#F1595C"}
        />
        <OrderChart
          className="bg-kog-999 dark:bg-kog-50 rounded p-4"
          barColor={"#50C793"}
        />
        <ProfitChart className="bg-kog-999 dark:bg-kog-50 rounded p-4" />
        <ProfitChart
          className="bg-kog-999 dark:bg-kog-50 rounded p-4"
          color={"#F1595C"}
        />{" "}
      ...
      <div className="grid xl:grid-cols-3 lg:grid-cols-2 grid-cols-1 gap-4">
        <EarningChart className="bg-kog-999 dark:bg-kog-50 rounded py-3 px-4" />
        <EarningChart className="bg-kog-999 dark:bg-kog-50 rounded py-3 px-4" />
        <EarningChart className="bg-kog-999 dark:bg-kog-50 rounded py-3 px-4" />
      </div>
    </div>
