      ...
      <div className="space-y-5">
              ...
              >
                ...
                <header className="mb-6">
                  ...
                  <div className="space-x-4 relative flex items-center mb-5 rtl:space-x-reverse">
                    ...
                    <span className="text-xs text-warning-500 font-medium px-3 py-1 rounded-full inline-block bg-kog-999 uppercase h-auto">
                      Save 20%
                    </span>
                  </div>
                ...
                <div className="price-body space-y-8">
                  <p className="text-sm leading-5 text-kog-white dark:text-slate-300">
        ...
        <div className="grid xl:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-5">
          {tables2.map((item, i) => (
            ...
            price-table rounded-[6px] shadow-base dark:bg-kog-50 p-6 text-slate-900 dark:text-white relative overflow-hidden z-[1]
            `}
              key={i}
            >
              <div className="overlay absolute right-0 top-0 w-full h-full z-[-1]">
              ...
              {item.ribon && (
                <div className="text-sm font-medium bg-kog-999 dark:bg-slate-700 text-slate-900 dark:text-slate-300 py-2 text-center absolute ltr:-right-[43px] rtl:-left-[43px] top-6 px-10 transform ltr:rotate-[45deg] rtl:-rotate-45">
                  {item.ribon}
                </div>
              )}
              <header className="mb-6">
             ...
             ${
              ...
              ${
                item.bg === "bg-slate-900"
                  ? "text-slate-100"
                  : "text-kog-white dark:text-slate-300"
              }
                text-sm leading-5
                `}
                >
