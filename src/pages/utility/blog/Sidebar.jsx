  ...
  return (
    <div className="space-y-5 divide-y divide-slate-100 dark:divide-slate-700 -mx-6">
      ...
      <div className="pt-4 px-6">
        <h4 className="text-kog-white dark:text-slate-300 text-xl font-medium mb-4">
          Latest Blogs Post
        </h4>
            ...
            <li key={i}>
              <div className="flex space-x-4 rtl:space-x-reverse">
                ...
                <div className="flex-1 flex flex-col">
                  <h4 className="text-sm text-kog-white font-regular leading-5 mb-4">
                    <Link to="#">
        ...
        <ul className="flex flex-wrap">
          {tags.map((item, i) => (
            <li key={i} className="mr-2 mb-2">
              <Link
                to={item.link}
                className="text-xs font-normal text-kog-white bg-slate-100 dark:bg-slate-600 dark:text-slate-300 py-1 px-3 rounded-full hover:bg-slate-900 hover:text-white transition duration-150"
              >
