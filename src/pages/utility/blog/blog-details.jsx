        ...
        <div className="flex-1">
          <div className="grid grid-cols-1 gap-5">
            <Card>
              ...
              <div className="card-text dark:text-slate-300 mt-4 space-y-4 leading-5 text-kog-white text-sm border-b border-slate-100 dark:border-slate-700 pb-6">
                <p>
                ...
                <ul className="lg:flex items-center lg:space-x-3 lg:rtl:space-x-reverse mt-4 border-b border-slate-100 dark:border-slate-700 pb-6">
                  ...
                  {tags.map((item, i) => (
                    <li key={i}>
                      <Link
                        to="#"
                        className="text-xs font-normal text-kog-white dark:text-slate-300 bg-slate-100 dark:bg-slate-600 py-1 px-3 rounded-full hover:bg-slate-900 hover:text-white transition duration-150"
                      >
                    ...
                    <div className="flex">
                      ...
                      <div className="flex-1">
                        <div className="flex flex-wrap justify-between mb-2">
                          <span className="text-kog-white text-base dark:text-slate-300 font-normal">
                            Marvin McKinney
                          </span>
