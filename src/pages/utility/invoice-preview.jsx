    ...
    <div>
      <div className="lg:flex justify-between flex-wrap items-center mb-6">
        ...
        <div className="flex lg:justify-end items-center flex-wrap space-xy-5">
          <button className="invocie-btn inline-flex btn btn-sm whitespace-nowrap space-x-1 cursor-pointer bg-kog-999 dark:bg-kog-50 dark:text-slate-300 btn-md h-min text-sm font-normal text-slate-900 rtl:space-x-reverse">
          ...
          <button
            type="button"
            onClick={printPage}
            className="invocie-btn inline-flex btn btn-sm whitespace-nowrap space-x-1 cursor-pointer bg-kog-999 dark:bg-kog-50 dark:text-slate-300 btn-md h-min text-sm font-normal text-slate-900 rtl:space-x-reverse"
          >
            <span className="text-lg">
      ...
      <Card bodyClass="p-0">
        <div className="flex justify-between flex-wrap space-y-4 px-6 pt-6 bg-slate-50 dark:bg-kog-50 pb-6 rounded-t-md">
          <div>
          ...
          <div className="space-y-[2px]">
            ...
            <h4 className="text-kog-white font-medium dark:text-slate-300 text-xs uppercase">
              Invoice number:
            </h4>
        ...
        <div className="py-10 text-center md:text-2xl text-xl font-normal text-kog-white dark:text-slate-300">
