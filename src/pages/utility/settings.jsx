        ...
        <Card>
          <div className="space-y-6">
            <div className="flex space-x-3 items-center rtl:space-x-reverse">
              <div className="flex-none h-8 w-8 rounded-full bg-kog-50 dark:bg-slate-700 text-slate-300 flex flex-col items-center justify-center text-lg">
            ...
            <div className="text-kog-white dark:text-slate-300 text-sm">
              Set up your company profile, add your company logo, and more
            </div>
            <Link
              to="#"
              className="inline-flex items-center space-x-3 rtl:space-x-reverse text-sm capitalize font-medium text-kog-white dark:text-slate-300"
            >
