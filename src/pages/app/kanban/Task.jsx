...
const Task = ({ task }) => {
  ...
  return (
    <Card className=" cursor-move">
      ...
      {/* description */}
      <div className="text-kog-white dark:text-slate-400 text-sm pt-4 pb-8">
        {des}
      </div>
      {/* assignee */}
      ...
      {/* progress bar */}
      <div className="ltr:text-right rtl:text-left text-xs text-kog-white dark:text-slate-300 mb-1 font-medium">
        {progress}%
      </div>
      ...
      <div className="grid grid-cols-2 gap-4 mt-6">
        ...
        <div>
          ...
          <div className="flex justify-start -space-x-1.5 rtl:space-x-reverse">
            ...
            <div className="bg-kog-999 dark:bg-kog-50 text-slate-900 dark:text-slate-300 text-xs ring-2 ring-slate-100 dark:ring-slate-700 rounded-full h-6 w-6 flex flex-col justify-center items-center">
              +2
            </div>
          </div>
        </div>
