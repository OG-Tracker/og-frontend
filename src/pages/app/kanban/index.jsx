      ...
      <div className="flex flex-wrap justify-between items-center mb-4">
        ...
        <div className="flex space-x-4 justify-end items-center rtl:space-x-reverse">
          <Button
            ...
            text="Add Board"
            className="bg-kog-50 dark:hover:bg-opacity-70   h-min text-sm font-medium text-slate-50 hover:ring-2 hover:ring-opacity-80 ring-slate-900  hover:ring-offset-1  dark:hover:ring-0 dark:hover:ring-offset-0"
                    ...
                    >
                      {(provided, snapshot) => (
                        ...
                        >
                          ...
                          >
                            {/* Board Header*/}
                            <div className="relative flex justify-between items-center bg-kog-999 dark:bg-kog-50 rounded shadow-base px-6 py-5">
                              <div
