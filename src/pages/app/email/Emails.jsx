  ...
  return (
    ...
    `}
      ...
      <p className="truncate">
        ...
        <span className="text-sm text-kog-white dark:text-slate-300 font-normal">
          {desc}
        </span>
      </p>
      ...
      <span>
        ...
        <span
          className="absolute ltr:right-0 rtl:left-0 top-1/2 -translate-y-1/2 dark:text-slate-300 group-hover:bg-slate-100 dark:group-hover:bg-kog-50 bg-kog-999 h-full w-[100px] flex flex-col items-center justify-center opacity-0 invisible group-hover:opacity-100 group-hover:visible"
          onClick={(e) => {
