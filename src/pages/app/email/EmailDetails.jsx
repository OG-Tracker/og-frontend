...
const EmailDetails = () => {
  ...
  return (
    <div className="absolute left-0 top-0 w-full h-full bg-kog-999 dark:bg-kog-50 z-[55] rounded-md p-6 overflow-y-auto">
      ...
      <div>
        <div className="text-lg font-medium text-kog-white dark:text-slate-300">
        ...
        <div className="flex space-x-3 pt-4 pb-6 items-start rtl:space-x-reverse">
          ...
          <div className="flex-1">
            <span className="text-sm text-kog-white dark:text-slate-300 font-medium leading-4">
              Esther Howard
            </span>
          </div>
        </div>
        <div className="text-sm text-kog-white dark:text-slate-300 font-normal">
          Hi Jane Cooper,
          <br />
          <br />
