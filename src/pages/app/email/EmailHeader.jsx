...
const EmailHeader = ({ onChange, checkboxChange, emails }) => {
  ...
  return (
    <div className="md:flex justify-between items-center sticky bg-kog-999 dark:bg-kog-50 top-0 pt-6 pb-4 px-6 z-[44] border-b border-slate-100 dark:border-slate-700 rounded-t-md">
        ...
        <div className="max-w-[180px] flex items-center space-x-1 rtl:space-x-reverse">
          ...
          <div>
            <input
              ...
              className="bg-transparent text-sm font-regular text-kog-white dark:text-slate-300 transition duration-150 rounded px-2 py-1 focus:outline-none"
            />
          </div>
        </div>
      </div>
              ...
              <div
                className={`
                  ...
                  ${"hover:bg-slate-900 dark:hover:bg-slate-600 dark:hover:bg-opacity-70  dark:text-slate-300 hover:text-white"}
                   w-full border-b border-b-gray-500 border-opacity-10   px-4 py-2 text-sm  last:mb-0 cursor-pointer first:rounded-t last:rounded-b flex  space-x-2 items-center  text-kog-white capitalize rtl:space-x-reverse `}
              >
