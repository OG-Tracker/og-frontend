    ...
    <div>
      <header>
        ...
        >
          <div
            ref={nodeRef}
            className="absolute bg-kog-999 dark:bg-kog-50 rounded-md h-full left-0 top-0 bottom-0  w-full z-[9]"
          >
            <SimpleBar className="h-full p-6">
              ...
              <header className="mx-auto max-w-[200px] mt-6 text-center">
                ...
                <span className="block text-kog-white dark:text-slate-300 text-sm">
                  Jane Cooper
                </span>
